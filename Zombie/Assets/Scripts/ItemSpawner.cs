...
public class ItemSpawner : MonoBehaviour
{
  ...
  private void Spawn()
  {
    var spawnPosition = this.GetRandomPointOnNavMesh(this.playerTransform.position, maxDistance);
