...
public class Gun : MonoBehaviourPun, IPunObservable
{
  ...
  // IPunObservable: PhotonView(Gun 오브젝트) 컴포넌트로 동기화를 구현할 모든 컴포넌트들이 구현해야 함
  // PhotonView 컴포넌트의 Observed Components에 등록되어 로컬-리모트 간 동기화

  // OnPhotonSerializeView: 로컬과 리모트 사이에서 어떤 값을 어떻게 주고받을지 결정
